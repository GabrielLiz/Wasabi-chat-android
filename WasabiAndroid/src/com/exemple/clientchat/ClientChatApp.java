...
public class ClientChatApp extends Activity {
    ...
    public void showContactList(){
		...
		try {
			clientOp.retreiveContactList();		
			
			LinkedList<ModelContact> contacts = clientOp.getContacts();
			String[] clientList = new String[contacts.size()];
			
			//Recover all the contacts name in string for displaying
			for(int i=0;i<contacts.size();i++){
				clientList[i] = contacts.get(i).getLogin();
			}
    ...
    public void addContact(View btn){
    	//TODO Permettre d'ajouter un contact
    ...
    public void ViewRequest(View btn){
    	...
    	printToast("Useless you already see all the users on the server! ;-)");
    	//TODO Voir ses demandes d'ajout de contact
